                ...
                <div class="ibox-content">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Prefecture / Ward </label>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-md-6">
                                            <?= $this->Form->control('prefecture', ['name' => 'prefecture','required'=> 'true','class' => 'form-control chosen-select prefecture', 'options' => array_unique(array_column($areas, 'prefecture')), 'onchange'=>"document.getElementById('pref_content').value=this.options[this.selectedIndex].text", 'empty' => true, 'placeholder' => 'Select prefecture', 'label' => false]); ?>
                                            <?= $this->Form->control('selected_pref', ['name' => 'prefecture','required'=> 'true','type' => 'hidden', 'id' => 'pref_content']); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?= $this->Form->control('ward', ['required'=> 'true','class' => 'form-control chosen-select ward', 'options' => array_column($areas, 'ward'), 'onchange'=>"document.getElementById('ward_content').value=this.options[this.selectedIndex].text", 'empty' => true, 'placeholder' => 'Select ward', 'label' => false]); ?>
